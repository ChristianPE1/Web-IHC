        ...
        <div className="flex flex-col justify-center items-center text-7xl 2xl:text-8xl font-bold [text-shadow:_0_8px_8px_rgb(0_0_0_/_0.8)]">
          ...
          <footer className="flex flex-row justify-center items-center gap-x-20 absolute bottom-0 mb-10 text-center text-2xl text-gray-400">
            <div onClick={() => navigateToProjects('about')}
              className={`z-20 cursor-pointer flex justify-center items-center gap-x-3 px-12 py-8 w-fit from-blue-600/60 via-slate-950/70 to-blue-500/60 bg-gradient-to-br text-white rounded-full border-white border-2 relative group overflow-hidden`}
            ...
            >
              ...
              <div
                ...
                style={{ backgroundImage: "url('/hero-imgs/bg-info-paint.png')" }}
              ></div>
            </div>
            ...
            >
              ...
              <div
                className="absolute inset-0 bg-cover bg-center opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                style={{ backgroundImage: "url('/hero-imgs/bg-objetivo-paint.png')" }}
              ></div>
            </div>
            ...
            >
              ...
              <div
                className="absolute inset-0 bg-cover bg-center opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                style={{ backgroundImage: "url('/hero-imgs/bg-anexo-paint.png')" }}
              ></div>
            </div>
